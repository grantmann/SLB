...
class LendersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lender" do
    assert_difference('Lender.count') do
      post lenders_url, params: { lender: { FeeRate: @lender.FeeRate, LenderName: @lender.LenderName, QuantityAvailable: @lender.QuantityAvailable, ReportDate: @lender.ReportDate, Sharecode: @lender.Sharecode } }
    end
  ...
  test "should update lender" do
    patch lender_url(@lender), params: { lender: { FeeRate: @lender.FeeRate, LenderName: @lender.LenderName, QuantityAvailable: @lender.QuantityAvailable, ReportDate: @lender.ReportDate, Sharecode: @lender.Sharecode } }
